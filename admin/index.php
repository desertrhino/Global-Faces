	...
	<div class="container">
		...
		<div class="mainContent">
			...
			if (!isset($_GET[Type]) || $_GET[Type] == "Config")
			{
				...
				{
					$query = "UPDATE tblConfig SET ConfigHomeTitle = '$_POST[HomeTitle]' WHERE ConfigID = '1'";
							...
							<div align="center">
								...
								<form name="thumbnail" action="<?php echo $_SERVER["PHP_SELF"];?>?Type=<?php echo $_GET[Type]; ?>" method="post">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">										
										...
										<tr>
											<td width="150" align="right" valign="top"><h2>Face Decription: </h2></td>
			...
			else if ($_GET[Type] == "Text")
			{
				if ($_GET[Submit] == "Text")
				{
					$query = "UPDATE tblConfig SET ConfigText = '$_POST[Text]' WHERE ConfigID = '1'";
					$result = mysql_query($query) or die ("Error in query: $query. " . mysql_error());
					echo "<h5>Site Text has been updated.</h5>";
				}
				...
				<div class="CollapsiblePanelContent">
					<form action="index.php?Type=<?php echo $_GET[Type]; ?>&Action=Edit&Submit=Bio" method="POST" enctype="multipart/form-data" name="Details" target="_self" id="Details">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td>
								<!-- CKEditor -->							
								<textarea class="ckeditor" cols="80" id="Bio" name="Bio" rows="10"><?php echo $Bio; ?></textarea>
								<script type="text/javascript">
									//<![CDATA[
								...
								<!-- BBEditor
								<script>edToolbar('Bio'); </script>
								<textarea name="Bio" cols="65" rows="30" class="ed" id="Bio"><?php //echo $Bio; ?></textarea> -->
								</td>
							</tr>
							<tr>
								<td><p align="center"><input type="image" src="images/submit.png" alt="submit" /></p></td>
							</tr>
						</table>
					</form>
				</div>
